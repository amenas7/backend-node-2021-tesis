...
const getIndicador = (req, res) => {
    ...
    count( case when historial_ticket.reinci = 1 and historial_ticket.distintivo = '2' then 1 end ) as reabierta,
    count( case when historial_ticket.distintivo = '1' then 1 end ) as total,
    round(count(case when historial_ticket.reinci = 1 and historial_ticket.distintivo = '2' then 1 end ) 
